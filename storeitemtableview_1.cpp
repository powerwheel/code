        ...
        : QStyledItemDelegate(p)
{
    ...
    style_radiobutton->setStyleSheet("QRadioButton{background-color: transparent; border:none;color:white;}");
...
void SelectButtonItemDelegate::drawRadioButton(QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index) const
{
    ...
    myOption.palette = style_radiobutton->palette();
   ...
   myOption.features |= QStyleOptionButton::Flat;
